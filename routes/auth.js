...
router.post('/register', async (req, res) => {
    ...
    try {
      ...
      const url = `https://celadon-horse-a0582a.netlify.app/activate/${activationToken}`;
...
router.post('/forgot-password', async (req, res) => {
  ...
  try {
    ...
    const url = `https://celadon-horse-a0582a.netlify.app/reset-password/${resetToken}`;
    transporter.sendMail({
      to: email,
